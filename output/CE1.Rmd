...
## Data and method
We will mainly focus our analyses on just two variables: eisced that shows the degree value of each respondent, and it is codified from "1 to 7 with 1 at the minimum and 7 as maximum", and the other variable is clmching that is codified from "1 to 4" where 1 means belief in climate change and its consequences and 4 not belief and not be worry about this phenomenon. As exposed in the research, in each of the six continent the connection between education and climate change belief is positive. [Crona]
...
## Conclusion
At the end of this short research, we can say that the relationship between this two variables is surely positive, but the correlation seems not to be so strong as expressed in previous research.  
