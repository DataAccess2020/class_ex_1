...
```
As can we say observing the regression, the relationship between this two variables (climate_chng and educ_level) is surely positive, but it is also possible to say that each education level have a high number of people believing in climate change and this value continue to increase until the maximum educational level. In fact, this make the regression quite linear but it will never be negative also thanks to a high and spread believing in this phenomenon. Just analyzing the results of the regression, it is possible to say that results seems to significant just in two case: with education level six and seven, showing the strong correlation between an higher education and believing in climate change and its consequences.
[reg]

## Conclusion
At the end of this short research, it is possible to confirm how stated in previous research: education and climate change seem to be strongly correlated almost with the highest level of education. But, the relationship do not seems to be as strong as previous stated because it seems to have a low correlation. On the other hand, if we just look at what is exposed in other research, not just education influences this value because there are many other and different factors such as political and cultural belief. [McCright] In fact, as have been stated in these research, both party identification and political belief seem to influence what people think about climate change. 
